  ...
  public static void updateCaPoolIssuancePolicy(String project, String location, String pool_Id)
    ...
    try (CertificateAuthorityServiceClient certificateAuthorityServiceClient =
      ...
      CaPool caPool = CaPool.newBuilder()
          ...
          .setIssuancePolicy(issuancePolicy).build();
      ...
      ApiFuture<Operation> futureCall = certificateAuthorityServiceClient.updateCaPoolCallable()
          .futureCall(updateCaPoolRequest);
      ...
      IssuancePolicy response = certificateAuthorityServiceClient
          .getCaPool(CaPoolName.of(project, location, pool_Id).toString()).getIssuancePolicy();
